...
*/
  ...
  function changeVersionNum() {
    let versionNum = '(BETA) T-Version 1.00.03'
...
function addLineItem () {
  ...
  let newRow = `<tr><td>PROJECT</td><td><input class="units" type="number" value=""></td><td>$125 PER LOT</td><td>$ <strong class="subtotal">0</strong></td></tr>`
